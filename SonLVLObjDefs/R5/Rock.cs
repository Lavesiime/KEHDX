...
namespace KEHDXObjectDefinitions.R5
{
	class Rock : ObjectDefinition
	{
		...
		{
			sprites[3] = sprites[0] = new Sprite(LevelData.GetSpriteSheet("R5/Objects.gif").GetSection(92, 18, 32, 32), -16, -16);
			
			sprites[1] = new Sprite(LevelData.GetSpriteSheet("Global/Display.gif").GetSection(168, 18, 16, 16), -8, -8);
		...
		{
			return (obj.PropertyValue == 3) ? debug : null;
		}
	}
}